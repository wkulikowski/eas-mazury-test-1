...
export class EAS extends ethereum.SmartContract {
  ...
  getASRegistry(): Address {
    let result = super.call("getASRegistry", "getASRegistry():(address)", []);

    return result[0].toAddress();
  }

  try_getASRegistry(): ethereum.CallResult<Address> {
  ...
  getAttestation(uuid: Bytes): EAS__getAttestationResultValue0Struct {
    let result = super.call(
      "getAttestation",
      "getAttestation(bytes32):((bytes32,bytes32,address,address,uint256,uint256,uint256,bytes32,bytes))",
      [ethereum.Value.fromFixedBytes(uuid)]
    );

    return result[0].toTuple() as EAS__getAttestationResultValue0Struct;
  }
  ...
  try_getAttestation(
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as EAS__getAttestationResultValue0Struct
    );
  }

  getAttestationsCount(): BigInt {
    let result = super.call(
      "getAttestationsCount",
      "getAttestationsCount():(uint256)",
      []
    );
  ...
  try_getAttestationsCount(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getAttestationsCount",
      "getAttestationsCount():(uint256)",
      []
  ...
  getReceivedAttestationUUIDs(
    ...
    let result = super.call(
      "getReceivedAttestationUUIDs",
      "getReceivedAttestationUUIDs(address,bytes32,uint256,uint256,bool):(bytes32[])",
      [
        ...
        ethereum.Value.fromBoolean(reverseOrder)
      ]
    );
  ...
  try_getReceivedAttestationUUIDs(
    recipient: Address,
    schema: Bytes,
    start: BigInt,
    length: BigInt,
  ...
  getReceivedAttestationUUIDsCount(recipient: Address, schema: Bytes): BigInt {
    let result = super.call(
      "getReceivedAttestationUUIDsCount",
      "getReceivedAttestationUUIDsCount(address,bytes32):(uint256)",
      [
        ethereum.Value.fromAddress(recipient),
        ethereum.Value.fromFixedBytes(schema)
      ]
  ...
  try_getReceivedAttestationUUIDsCount(
    recipient: Address,
    schema: Bytes
  ...
  getRelatedAttestationUUIDs(
    ...
    let result = super.call(
      "getRelatedAttestationUUIDs",
      "getRelatedAttestationUUIDs(bytes32,uint256,uint256,bool):(bytes32[])",
      [
        ethereum.Value.fromFixedBytes(uuid),
        ethereum.Value.fromUnsignedBigInt(start),
        ethereum.Value.fromUnsignedBigInt(length),
  ...
  try_getRelatedAttestationUUIDs(
    uuid: Bytes,
    start: BigInt,
    length: BigInt,
    reverseOrder: boolean
  ...
  getRelatedAttestationUUIDsCount(uuid: Bytes): BigInt {
    let result = super.call(
      "getRelatedAttestationUUIDsCount",
      "getRelatedAttestationUUIDsCount(bytes32):(uint256)",
      [ethereum.Value.fromFixedBytes(uuid)]
    );
  ...
  try_getRelatedAttestationUUIDsCount(
    uuid: Bytes
  ): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getRelatedAttestationUUIDsCount",
  ...
  getSchemaAttestationUUIDs(
    ...
    let result = super.call(
      "getSchemaAttestationUUIDs",
      "getSchemaAttestationUUIDs(bytes32,uint256,uint256,bool):(bytes32[])",
      [
        ethereum.Value.fromFixedBytes(schema),
        ethereum.Value.fromUnsignedBigInt(start),
        ethereum.Value.fromUnsignedBigInt(length),
  ...
  getSchemaAttestationUUIDsCount(schema: Bytes): BigInt {
    let result = super.call(
      "getSchemaAttestationUUIDsCount",
      "getSchemaAttestationUUIDsCount(bytes32):(uint256)",
      [ethereum.Value.fromFixedBytes(schema)]
    );
  ...
  try_getSchemaAttestationUUIDsCount(
    schema: Bytes
  ): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getSchemaAttestationUUIDsCount",
  ...
  getSentAttestationUUIDs(
    ...
    let result = super.call(
      "getSentAttestationUUIDs",
      "getSentAttestationUUIDs(address,bytes32,uint256,uint256,bool):(bytes32[])",
      [
  ...
  getSentAttestationUUIDsCount(recipient: Address, schema: Bytes): BigInt {
    let result = super.call(
      "getSentAttestationUUIDsCount",
      "getSentAttestationUUIDsCount(address,bytes32):(uint256)",
      [
        ethereum.Value.fromAddress(recipient),
        ethereum.Value.fromFixedBytes(schema)
      ]
  ...
  try_getSentAttestationUUIDsCount(
    recipient: Address,
    schema: Bytes
  ): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
